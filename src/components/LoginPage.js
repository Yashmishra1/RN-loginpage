...
const Login = ({navigation}) => {
  ...
  const fingerid = () => {
    Alert.alert('Incorrect Fingerprint');
  };

  const faceid = () => {
    Alert.alert('Incorrect FaceID');
  };
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={styles.container}>
          ...
          <View style={styles.bottom}>
            <Pressable style={styles.fingerbtn} onPress={() => navigation.navigate("Touch")}>
              <Image source={require('../assets/images/ic_fingerprint.png')} />
              <Text style={{fontSize: 13}}> Sign In Using Touch ID</Text>
            </Pressable>
            <Pressable style={styles.facebtn} onPress={() => navigation.navigate("Face")}>
